...
import { violetBorder } from "../../constants/colors";
  ...
  return isLoading ? (
    ...
    >
      ...
      >
        ...
        <Avatar src={umpire?.photo?.url} alt={umpire?.fullName} sx={{ width: 150, height: 150 , border:`3px solid ${violetBorder}`}} />
...
export default AppLayout(UmpireDetails);
